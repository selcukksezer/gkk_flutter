...
$pattern = 'class _HeroSection extends StatelessWidget \{[\s\S]*?^\}'
$newClass = @'
    ...
    return Container(
      ...
      child: Stack(
        children: [
          ...
          // Content Left
          Padding(
            padding: const EdgeInsets.only(left: 20, top: 24, bottom: 24, right: 140),
            child: Column(
...
'@
$content = [regex]::Replace($content, $pattern, $newClass, 'Multiline')
